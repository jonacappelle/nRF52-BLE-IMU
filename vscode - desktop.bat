...
set NRF_SDK=C:/Users/JonaCappelle/Box/NOMADe/SOFTWARE/nRF5_SDK_17.0.2_d674dde
...
set GNU_TOOLS=C:/Users/JonaCappelle/Box/NOMADe/SOFTWARE/nRF5_SDK_17.0.2_d674dde/xpack-windows-build-tools-4.2.1-2/bin

rem Location of SEGGER JLink tools
set SEGGER_TOOLS=C:/Program Files (x86)/SEGGER/JLink

rem Location of java
set JAVA=C:/Program Files/Java/jre1.8.0_281/bin/java.exe
